*This repository is a mirror of the [component](http://component.io) module [kmalakoff/knockback](http://github.com/kmalakoff/knockback). It has been modified to work with NPM+Browserify. You can install it using the command `npm install npmcomponent/kmalakoff-knockback`. Please do not open issues or send pull requests against this repo. If you have issues with this repo, report it to [npmcomponent](https://github.com/airportyh/npmcomponent).*
...
* Full Library [(dev, 64k)](https://raw.github.com/kmalakoff/knockback/0.18.5/knockback.js) or [(min+gzip, 8k)](https://raw.github.com/kmalakoff/knockback/0.18.5/knockback.min.js)
* Full Stack [(dev, 330k)](https://raw.github.com/kmalakoff/knockback/0.18.5/knockback-full-stack.js) or [(min+gzip, 32k)](https://raw.github.com/kmalakoff/knockback/0.18.5/knockback-full-stack.min.js)
...
* Core Library [(dev, 54k)](https://raw.github.com/kmalakoff/knockback/0.18.5/knockback-core.js) or [(min+gzip, 7k)](https://raw.github.com/kmalakoff/knockback/0.18.5/knockback-core.min.js)
* Core Stack [(dev, 315k)](https://raw.github.com/kmalakoff/knockback/0.18.5/knockback-core-stack.js) or [(min+gzip, 31k)](https://raw.github.com/kmalakoff/knockback/0.18.5/knockback-core-stack.min.js)
